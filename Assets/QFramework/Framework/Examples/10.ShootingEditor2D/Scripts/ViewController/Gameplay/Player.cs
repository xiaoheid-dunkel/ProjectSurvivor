...
namespace ShootingEditor2D
{
    public class Player : ShootingEditor2DController
    {
        ...
        private void FixedUpdate()
        {
            ...
            mRigidbody2D.linearVelocity = new Vector2(horizontalMovement * 5, mRigidbody2D.linearVelocity.y);

            var grouded = mGroundCheck.Triggered;
            
            if (mJumpPressed && grouded)
            {
                mRigidbody2D.linearVelocity = new Vector2(mRigidbody2D.linearVelocity.x, 5);
            }
